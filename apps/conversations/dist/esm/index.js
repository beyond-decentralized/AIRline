...
Comment = __decorate$o([
    Entity(),
    Table()
], Comment);

let CommentReference = class CommentReference extends AirEntity {
};
__decorate$o([
    ManyToOne()
], CommentReference.prototype, "reference", void 0);
__decorate$o([
    ManyToOne()
], CommentReference.prototype, "referredFrom", void 0);
CommentReference = __decorate$o([
    Entity(),
    Table()
], CommentReference);
...
Conversation = __decorate$o([
    Entity(),
    Table()
], Conversation);

let Moderator = class Moderator extends AirEntity {
};
__decorate$o([
    ManyToOne()
], Moderator.prototype, "conversation", void 0);
__decorate$o([
    ManyToOne(),
    JoinColumn()
], Moderator.prototype, "userAccount", void 0);
Moderator = __decorate$o([
    Entity(),
    Table()
], Moderator);
...
export { COMMENT_API, CONVERSATION_API, Comment, CommentApi, CommentReference, Conversation, ConversationApi, Moderator, Participant, Q, Q_APPLICATION, TakeBackRequest, conversations, diSet, duoDiSet };
