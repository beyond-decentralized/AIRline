...
const conversations = domain('beyond-decentralized.world').app('at__airline__slash__conversations');
const COMMENT_API = conversations.token({
    class: null,
    interface: 'CommentApi',
    token: 'COMMENT_API'
});
const CONVERSATION_API = conversations.token({
    class: null,
...
exports.CommentApi = class CommentApi {
    constructor() {
...
__decorate$o([
    Inject()
], exports.CommentApi.prototype, "commentApi", void 0);
exports.CommentApi = __decorate$o([
    Injected()
], exports.CommentApi);

// An API stub for other Applications and UIs to use
exports.ConversationApi = class ConversationApi {
    constructor() {
...
__decorate$o([
    Inject()
], exports.ConversationApi.prototype, "conversationApi", void 0);
exports.ConversationApi = __decorate$o([
    Injected()
...
exports.Comment = class Comment extends AirEntity {
};
__decorate$o([
    Column()
], exports.Comment.prototype, "text", void 0);
__decorate$o([
    Column()
], exports.Comment.prototype, "takenBack", void 0);
__decorate$o([
    Column()
], exports.Comment.prototype, "takenBackDttm", void 0);
__decorate$o([
    Column()
], exports.Comment.prototype, "censored", void 0);
__decorate$o([
    Column()
], exports.Comment.prototype, "sensoredDttm", void 0);
__decorate$o([
    ManyToOne()
], exports.Comment.prototype, "conversation", void 0);
__decorate$o([
    ManyToOne()
], exports.Comment.prototype, "source", void 0);
__decorate$o([
    ManyToOne()
], exports.Comment.prototype, "censoredBy", void 0);
__decorate$o([
    OneToMany()
], exports.Comment.prototype, "replies", void 0);
__decorate$o([
    OneToMany()
], exports.Comment.prototype, "references", void 0);
__decorate$o([
    OneToMany()
], exports.Comment.prototype, "referredFrom", void 0);
__decorate$o([
    OneToMany()
], exports.Comment.prototype, "madeTakeBackRequest", void 0);
__decorate$o([
    OneToMany()
], exports.Comment.prototype, "takeBackRequests", void 0);
exports.Comment = __decorate$o([
    Entity(),
    Table()
], exports.Comment);

exports.CommentReference = class CommentReference extends AirEntity {
};
__decorate$o([
    ManyToOne()
], exports.CommentReference.prototype, "reference", void 0);
__decorate$o([
    ManyToOne()
], exports.CommentReference.prototype, "referredFrom", void 0);
exports.CommentReference = __decorate$o([
    Entity(),
    Table()
], exports.CommentReference);

exports.Conversation = class Conversation extends AirEntity {
    constructor() {
        super(...arguments);
        this.participants = [];
        this.moderators = [];
...
__decorate$o([
    Column()
], exports.Conversation.prototype, "name", void 0);
__decorate$o([
    ManyToOne()
], exports.Conversation.prototype, "topic", void 0);
__decorate$o([
    OneToMany()
], exports.Conversation.prototype, "participants", void 0);
__decorate$o([
    OneToMany()
], exports.Conversation.prototype, "moderators", void 0);
__decorate$o([
    OneToMany()
], exports.Conversation.prototype, "comments", void 0);
exports.Conversation = __decorate$o([
    Entity(),
    Table()
], exports.Conversation);

exports.Moderator = class Moderator extends AirEntity {
};
__decorate$o([
    ManyToOne()
], exports.Moderator.prototype, "conversation", void 0);
__decorate$o([
    ManyToOne(),
    JoinColumn()
], exports.Moderator.prototype, "userAccount", void 0);
exports.Moderator = __decorate$o([
    Entity(),
    Table()
], exports.Moderator);

exports.Participant = class Participant extends AirEntity {
};
__decorate$o([
    ManyToOne()
], exports.Participant.prototype, "conversation", void 0);
__decorate$o([
    ManyToOne(),
    JoinColumn()
], exports.Participant.prototype, "userAccount", void 0);
exports.Participant = __decorate$o([
    Entity(),
    Table()
], exports.Participant);

exports.TakeBackRequest = class TakeBackRequest extends AirEntity {
};
__decorate$o([
    ManyToOne()
], exports.TakeBackRequest.prototype, "forComment", void 0);
__decorate$o([
    ManyToOne()
], exports.TakeBackRequest.prototype, "viaComment", void 0);
exports.TakeBackRequest = __decorate$o([
    Entity(),
    Table()
], exports.TakeBackRequest);

const __constructors__ = {
    Comment: exports.Comment,
    CommentReference: exports.CommentReference,
    Conversation: exports.Conversation,
    Moderator: exports.Moderator,
    Participant: exports.Participant,
    TakeBackRequest: exports.TakeBackRequest
};
const Q_APPLICATION = {
    __constructors__,
...
COMMENT_API.setClass(exports.CommentApi);
COMMENT_API.setDependencies({
    interAppApiClient: INTER_APP_API_CLIENT
});
CONVERSATION_API.setClass(exports.ConversationApi);
CONVERSATION_API.setDependencies({
    interAppApiClient: INTER_APP_API_CLIENT
});

exports.COMMENT_API = COMMENT_API;
exports.CONVERSATION_API = CONVERSATION_API;
exports.Q = Q;
