...
RecordHistoryNewValue = __decorate$l([
    Entity(),
    Table()
...
RecordHistoryOldValue = __decorate$k([
    Entity(),
    Table()
...
RepositoryTransactionHistory = __decorate$j([
    Entity(),
    Table()
...
ContainerAccessor = __decorate$i([
    Injected()
], ContainerAccessor);
...
DbApplicationUtils = __decorate$h([
    Injected()
], DbApplicationUtils);
...
TransactionHistory = __decorate$g([
    Entity(),
    Table()
], TransactionHistory);
...
RepositoryApplication = __decorate$b([
    Entity(),
    Table()
...
RepositoryDatabase = __decorate$9([
    Entity(),
    Table()
], RepositoryDatabase);
...
RepositoryTerminal = __decorate$8([
    Entity(),
    Table()
], RepositoryTerminal);
...
exports.Theme = class Theme extends AirEntity {
};
__decorate$o([
    OneToMany()
], exports.Theme.prototype, "topics", void 0);
exports.Theme = __decorate$o([
    Entity(),
    Table()
], exports.Theme);

exports.Topic = class Topic extends AirEntity {
};
__decorate$o([
    ManyToOne()
], exports.Topic.prototype, "theme", void 0);
exports.Topic = __decorate$o([
    Entity(),
    Table()
], exports.Topic);
...
const topics = domain('beyond-decentralized.world').app('at__airline__slash__topics');
const TOPIC_API = topics.token({
    class: null,
    interface: 'TopicApi',
    token: 'TOPIC_API'
});
const THEME_API = topics.token({
    class: null,
    interface: 'ThemeApi',
    token: 'THEME_API'
});
...
exports.THEME_API = THEME_API;
exports.TOPIC_API = TOPIC_API;
exports.diSet = diSet;
