...
let GoalTask = class GoalTask extends AirEntity {
};
__decorate$o([
    ManyToOne()
], GoalTask.prototype, "goal", void 0);
__decorate$o([
    ManyToOne()
], GoalTask.prototype, "task", void 0);
GoalTask = __decorate$o([
    Entity(),
    Table()
], GoalTask);

let PrerequisiteTask = class PrerequisiteTask extends AirEntity {
};
__decorate$o([
    ManyToOne()
], PrerequisiteTask.prototype, "prerequisiteTask", void 0);
__decorate$o([
    ManyToOne()
], PrerequisiteTask.prototype, "requiringTask", void 0);
PrerequisiteTask = __decorate$o([
    Entity(),
    Table()
], PrerequisiteTask);

let Subtask = class Subtask extends AirEntity {
};
__decorate$o([
    ManyToOne()
], Subtask.prototype, "supertask", void 0);
__decorate$o([
    ManyToOne()
], Subtask.prototype, "subtask", void 0);
Subtask = __decorate$o([
    Entity(),
    Table()
], Subtask);
...
__decorate$o([
    OneToMany()
], Task.prototype, "goalTasks", void 0);
__decorate$o([
    OneToMany()
...
TaskConversation = __decorate$o([
    Entity(),
    Table()
], TaskConversation);

var TaskDurationUnit;
...
TaskReferenceInComment = __decorate$o([
    Entity(),
    Table()
...
export { GOAL_API, Goal, GoalApi, GoalConversation, GoalStatus, GoalTask, PrerequisiteTask, Q, Q_APPLICATION, Subtask, TASK_API, Task, TaskApi, TaskAssignee, TaskConversation, TaskDurationUnit, TaskReferenceInComment, TaskStatus, diSet, duoDiSet, tasks };
